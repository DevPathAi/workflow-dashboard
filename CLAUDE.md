# CLAUDE.md — workflow-dashboard

> DevPath AI 팀 워크플로우 진행 대시보드 (GitHub Pages). `project-dashboard` 스킬로 생성·관리.
...
- 설치: `npm install`
- 푸시 전 필수 검증(전부 통과해야 함): `npm run lint` · `npm run validate:data` · `npm run build`
